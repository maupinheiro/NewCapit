...
namespace DAL
{
    public class ConMotoristas
    {
        ...
        public static DataTable FetchDataTableAvaliacao()
        {
            ...
            string sql = "SELECT caminhofoto, codmot, nommot, cargo, CONVERT(varchar, cadmot, 103) AS cadmot, frota, nucleo, id FROM tbmotoristas where fl_exclusao is null and status = 'ATIVO' ORDER BY nommot";
