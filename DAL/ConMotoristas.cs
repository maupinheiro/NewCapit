...
namespace DAL
{
    public class ConMotoristas
    {
        ...
        {
            string sql = "SELECT caminhofoto, codmot, nommot, cargo, tipomot, funcao, horario, codtra, transp, nucleo, CONVERT(varchar, dtnasc, 103) AS dtnasc, cpf, CONVERT(varchar, cadmot, 103) AS cadmot, status, id FROM tbmotoristas where fl_exclusao is null and codmot LIKE @searchTerm or nommot LIKE @searchTerm  ORDER BY nommot";
