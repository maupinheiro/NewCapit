...
namespace DAL
{
    public class ConAgregados
    {
        ...
        {
            string sql = "SELECT id, codtra, fantra, pessoa, cnpj, filial, fone2, ativa_inativa FROM tbtransportadoras where fl_exclusao is null and codtra LIKE @searchTerm OR fantra LIKE @searchTerm or cnpj LIKE @searchTerm  ORDER BY fantra";
