...
namespace DAL
{
    public class ConVeiculos
    {
        ...
        {
            //string sql = "SELECT id, codvei, tipvei, plavei, reboque1, reboque2, tipoveiculo, nucleo, transp, ativo_inativo FROM tbveiculos where fl_exclusao is null and plavei LIKE @searchTerm or codvei LIKE @searchTerm or nucleo LIKE @searchTerm or transp LIKE @searchTerm or tipvei LIKE @searchTerm or reboque1 LIKE @searchTerm or reboque2 LIKE @searchTerm or tipoveiculo LIKE @searchTerm ORDER BY codvei";
