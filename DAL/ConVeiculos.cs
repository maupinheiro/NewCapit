...
namespace DAL
{
    public class ConVeiculos
    {
        ...
        {
            string sql = "SELECT id, codvei, tipvei, plavei, reboque1,reboque2, rastreamento,rastreador, tipoveiculo, nucleo, transp, ativo_inativo FROM tbveiculos where fl_exclusao is null";
