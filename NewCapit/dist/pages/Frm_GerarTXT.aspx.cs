...
namespace NewCapit.dist.pages
{
    public partial class Frm_GerarTXT : System.Web.UI.Page
    {
        ...
        protected void btnConferencia_Click(object sender, EventArgs e)
        {
            ...
            else if (chkMotorista.Checked)
            {
                ...
                filial = txtCodMotorista.Text;


            }
            string url = "ConfereArquivo.aspx?dataini="+txtDtInicial.Text+"&datafim="+txtDtFinal.Text+"&filial="+filial+"";
        ...
        public void Txt5e()
        {
            ...
            if (chkDiadema.Checked)
            {
                arquivo1 = "Tngcnt" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + DateTime.Now.ToString("ddMM-HHmm") + ".txt";
            }
            else if (chkCadiriri.Checked)
            {
                arquivo1 = "Tngmatriz" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + DateTime.Now.ToString("ddMM-HHmm") + ".txt";
            }
            else if (chkMinas.Checked)
            {
                arquivo1 = "Tngminas" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + DateTime.Now.ToString("ddMM-HHmm") + ".txt";

            }
            else if (chkTaubate.Checked)
            {
                arquivo1 = "TngTaubate" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + DateTime.Now.ToString("ddMM-HHmm") + ".txt";
            }
            else if (chkSaoCarlos.Checked)
            {
                arquivo1 = "TngSaoCarlos" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + DateTime.Now.ToString("ddMM-HHmm") + ".txt";
            }
            //else if (chkBahia.Checked)
            //{
            ...
            {
                arquivo1 = "Tngipiranga" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + DateTime.Now.ToString("ddMM-HHmm") + ".txt";
            }

            else if (chkMotorista.Checked)
            {
                arquivo1 = txtCodMotorista.Text + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + DateTime.Now.ToString("ddMM-HHmm") + ".txt";
            }


            dtcriacao = DateTime.Now.ToString("ddMM-HHmm");
            string caminho1 = Server.MapPath("/TXT/");
            ...
            for (int x = 0; x < dt1.Rows.Count; x++)
            {
                ...
                for (int f = 0; f < dte.Rows.Count; f++)
                {
                    ...
                    if (chkDiadema.Checked)
                    {
                        arquivo = "Tngcnt" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") +"-"+dtcriacao+ ".txt";
                    }
                    else if (chkCadiriri.Checked)
                    {
                        arquivo = "Tngmatriz" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + dtcriacao + ".txt";
                    }
                    else if (chkMinas.Checked)
                    {
                        arquivo = "Tngminas" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + dtcriacao + ".txt";
                    ...
                    {
                        arquivo = "Tngipiranga" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + dtcriacao + ".txt";
                    }
                    else if (chkTaubate.Checked)
                    {
                        arquivo = "TngTaubate" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + dtcriacao + ".txt";
                    }
                    else if (chkSaoCarlos.Checked)
                    {
                        arquivo = "TngSaoCarlos" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + dtcriacao + ".txt";
                    }
                    else if (chkMotorista.Checked)
                    {
                        arquivo = txtCodMotorista.Text + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "a" + DateTime.Parse(txtDtFinal.Text).ToString("ddMM") + "-" + dtcriacao + ".txt";
                    }
                                    ...
                                    for (int w = 0; w < dt4.Rows.Count; w++)
                                    {
                                        ...
                                        if (dt4.Rows[w][2].ToString() == "PARADA REFEICAO")
                                        {
                                            ...
                                            if (a >= 0)
                                            {
                                                ...
                                                //    }
                                                //}
                                                if (dt4.Rows[a][2].ToString() == "INICIO DE JORNADA" || dt4.Rows[a][2].ToString() == "INICIO JORNADA CAMINHAO" || dt4.Rows[a][2].ToString() == "INICIO JORNADA" || dt4.Rows[a][2].ToString() == "RETORNO PERNOITE")
                                                {
                                                    //write.WriteLine(cracha + ";" + data + ";" + hora + ";1;0202");
                                                    //write.WriteLine(cracha + ";" + data + ";" + hora + ";1;0193");
                                                    write.WriteLine("+00" + hora.Replace(":", "") + data.Replace("/", "") + cracha.PadLeft(10, '0') + "01930000");
            ...
            //sb.Append("</script>");
            //ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", sb.ToString());
            string linha1 = "Gerado com Sucesso!";
            ...
            txtNomMot.Text = string.Empty;
            txtFilialMot.Text = string.Empty;
            chkCadiriri.Checked = false;
            chkDiadema.Checked = false;
            chkIpiranda.Checked = false;
            chkMinas.Checked = false;
        ...
        {
            ddlEscolherArquivo.DataSource = null;
