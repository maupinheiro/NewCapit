        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <asp:GridView runat="server" OnRowDataBound="gvListLimiteCredito_RowDataBound" ID="gvListLimiteCredito" CssClass="table table-bordered dataTable1 table-hover" Width="100%" AutoGenerateColumns="False" DataKeyNames="ID" HeaderStyle-CssClass="gv-header-custom" OnRowCommand="gvListLimiteCredito_RowCommand" AllowPaging="True" PageSize="75" OnPageIndexChanging="gvListLimiteCredito_PageIndexChanging" ShowHeaderWhenEmpty="True">
