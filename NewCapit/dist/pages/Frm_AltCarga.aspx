<%@ Page Title="" Language="C#" MasterPageFile="~/dist/pages/Main.Master" AutoEventWireup="true" CodeBehind="Frm_AltCarga.aspx.cs" Inherits="NewCapit.dist.pages.Frm_AltCarga" %>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-clipboard-list"></i>&nbsp;CARGAS - ATUALIZAÇÃO:&nbsp;
                ...
                <div class="card-header">
                    <div class="form-group row">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <asp:TextBox ID="txtID" runat="server" CssClass="form-control" Style="text-align: center" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                   <%-- <div class="form-group row">
