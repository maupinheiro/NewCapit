<%@ Page Title="" Language="C#" MasterPageFile="~/dist/pages/Main.Master" AutoEventWireup="true" CodeBehind="Frm_AltCarreta.aspx.cs" Inherits="NewCapit.dist.pages.Frm_AltCarreta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            let txtDt_Cadastro = document.getElementById("<%= txtDt_Cadastro.ClientID %>");
            ...
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-shipping-fast"></i>&nbsp;CARRETAS - ATUALIZAÇÃO DE DADOS</h3>
                    </div>
                </div>
                <div class="card-header">
                    <!-- linha 1 -->
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <span class="">TIPO DE REBOQUE:</span>
                        ...
                        <div class="col-md-3" id="alteracao" runat="server" visible="false">
                            <div class="form_group">
                                <span class="details">usuario alteração:</span>
                                <asp:TextBox ID="Alterado_Por" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form_group">
                                <span class="details">CADASTRO:</span>
                                <asp:TextBox ID="txtDt_Cadastro" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                            ...
                            <div class="row g-3">
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPlaca" Style="text-align: center" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                    ...
                    <!-- dados do cavalo e viagens -->
                    <div class="card card-outline card-info collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="far fa-edit"></i>&nbsp;Seguro / Última Viagem</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <span class="details">TIPO DE SEGURO:</span>
                                        <asp:TextBox ID="txtTipo_De_Seguro" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <span class="details">COMPANHIA:</span>
                                        <asp:TextBox ID="txtCompanhia" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <span class="details">APOLICE:</span>
                                        <asp:TextBox ID="txtApolice" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <span class="details">VALIDADE:</span>
                                        <asp:TextBox ID="txtValidade" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <span class="details">FRANQUIA:</span>
                                        <asp:TextBox ID="txtValor_Franquia" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <span class="details">ÚLITMA VIAGEM:</span>
                                        <asp:TextBox ID="txtData_Ultima_Viagem" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <span class="details">VEÍCULO:</span>
                                        <asp:TextBox ID="txtFrota" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <span class="details">PLACA:</span>
                                        <asp:TextBox ID="txtPlaca_Cavalo" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <span class="details">TRANSPORTADOR:</span>
                                        <asp:TextBox ID="txtTransportador" runat="server" Style="text-align: center" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Inativação -->
                <div class="row g-3" id="colunaInativo" runat="server">
                    <div class="col-md-2">
                        <div class="form-group">
                            <span class="details">DATA:</span>
                            <asp:TextBox ID="txtData_Inativo" runat="server" Style="text-align: center" CssClass="form-control" placeholder=""></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <span class="details">MOTIVO DA INATIVAÇÃO:</span>
                            <asp:TextBox ID="txtMotivo_Inativacao" runat="server" Style="text-align: left" CssClass="form-control" placeholder="" MaxLength="60"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtData_Alteracao" runat="server" Style="text-align: center" CssClass="form-control" placeholder=""></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <span class="details">POR:</span>
                            <asp:TextBox ID="txtAlterado_Por" runat="server" Style="text-align: left" CssClass="form-control" placeholder="" MaxLength="60"></asp:TextBox>
                        </div>
                    </div>
                </div>
