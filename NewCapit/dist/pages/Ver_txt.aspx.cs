...
{
    public partial class Ver_txt : System.Web.UI.Page
    {
        ...
        protected void chkBahia_CheckedChanged(object sender, EventArgs e)
        {
            chkDiadema.Checked = false;
            chkBahia.Checked = true;
            chkCadiriri.Checked = false;
            chkIpiranda.Checked = false;
            chkMinas.Checked = false;
        }
        ...
        public void Txt5b()
        {
            ...
            for (int x = 0; x < dt1.Rows.Count; x++)
            {
                ...
                {
                    string sql3 = "select * from tb_parada where cod_cracha='" + dt1.Rows[x][0].ToString() + "' and dt_posicao_parada ='" + DateTime.Parse(dte.Rows[f][0].ToString()).ToString("yyyy-MM-dd") + "' and fl_deletado is null  order by dt_posicao_parada, hr_posicao";
                    ...
                    if (chkDiadema.Checked)
                    {
                        arquivo = "Tngcnt" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
                    }
                    else if (chkCadiriri.Checked)
                    {
                        arquivo = "Tngmatriz" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
                    }
                    else if (chkMinas.Checked)
                    {
                        arquivo = "Tngminas" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";

                    }
                    else if (chkBahia.Checked)
                    {
                        arquivo = "Tngbahia" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
                    }
                    else if (chkIpiranda.Checked)
                    {
                        arquivo = "Tngipiranga" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
                    }
                    else
                    {
                        arquivo = "Todos" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
                    }
                        ...
                        if (dt3.Rows[0][6].ToString() == "INICIO DE JORNADA" || dt3.Rows[0][6].ToString() == "REINICIO DE VIAGEM" || dt3.Rows[0][6].ToString() == "PARADA PERNOITE")
                        {
                            ...
                            if (dtv.Rows[0][0].ToString() == "FIM DE JORNADA")
                            {
                                ...
                                for (int w = 0; w < dt4.Rows.Count; w++)
                                {
                                    ...
                                    if (dt1.Rows[x][0].ToString().Length <= 3)
                                    {
                                        cracha = "300" + dt1.Rows[x][0].ToString();
                                    }
                                    else if (dt1.Rows[x][0].ToString().Length > 3 && dt1.Rows[x][0].ToString().Length <= 4)
                                    {
                                    ...
                                    string data = DateTime.Parse(dt4.Rows[w][0].ToString()).ToString("dd/MM/yyyy");
                                    ...
                                    if (dt4.Rows[w][2].ToString() == "RETORNO REFEICAO")
                                    {
                                        ...
                                        if (a >= 0)
                                        {
                                            ...
                                            if (dt4.Rows[a][2].ToString() == "PARADA INTERNA")
                                            {
                                                if (dt4.Rows[a][5].ToString() == "2" || dt4.Rows[a][5].ToString() == "3")
                                                {
                                                    write.WriteLine(cracha + ";" + data + ";" + hora + ";1;21");
                                                    write.WriteLine(cracha + ";" + data + ";" + hora + ";2;93");
                                                }
                                            }
                                            else if (dt4.Rows[b][2].ToString() == "FIM DE JORNADA")
                                            {
                                                write.WriteLine(cracha + ";" + data + ";" + hora + ";1;93");
                                                write.WriteLine(cracha + ";" + data + ";" + hora + ";2;2");
                                            }
                        ...
                        else
                        {
                            ...
                            if (dtz.Rows[0][0].ToString() == "FIM DE JORNADA" || dtz.Rows[0][0].ToString() == "PARADA PERNOITE")
                            {
                                ...
                                if (dtd.Rows.Count > 0)
                                {
                                    ...
                                    sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada='" + DateTime.Parse(dte.Rows[f][0].ToString()).ToString("yyyy-MM-dd") + "' and fl_deletado is null and hr_posicao >= '" + dtd.Rows[0][1].ToString() + "' order by dt_posicao_parada, hr_posicao";
                                    // string sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada between '" + txtDtInicial.Text + "' and '" + txtDtFinal.Text + "' order by dt_posicao_parada, hr_posicao";
                                    SqlDataAdapter adtp4 = new SqlDataAdapter(sql4, con);
                                    DataTable dt4 = new DataTable();
        ...
        public void Txt5c()
        {
            ...
            if (chkDiadema.Checked)
            {
                arquivo1 = "Tngcnt" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
            }
            else if (chkCadiriri.Checked)
            {
                arquivo1 = "Tngmatriz" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
            }
            else if (chkMinas.Checked)
            {
                arquivo1 = "Tngminas" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";

            }
            else if (chkBahia.Checked)
            {
                arquivo1 = "Tngbahia" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
            }
            else if (chkIpiranda.Checked)
            {
                arquivo1 = "Tngipiranga" + DateTime.Parse(txtDtInicial.Text).ToString("ddMM") + "001.txt";
            }
                    ...
                    if (dt3.Rows.Count > 0)
                    {
                        if (dt3.Rows[0][6].ToString() == "INICIO DE JORNADA" || dt3.Rows[0][6].ToString() == "REINICIO DE VIAGEM" || dt3.Rows[0][6].ToString() == "PARADA PERNOITE")
                        {
                            ...
                            if (dtv.Rows[0][0].ToString() == "FIM DE JORNADA")
                            {
                                ...
                                sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada='" + DateTime.Parse(dte.Rows[f][0].ToString()).ToString("yyyy-MM-dd") + "' AND (ds_macro IN ('INICIO DE JORNADA', 'INICIO JORNADA CAMINHAO', 'PARADA REFEICAO', 'FIM DE JORNADA','REINICIO DE VIAGEM','FIM DE VIAGEM', 'PARADA','INICIO DE VIAGEM','RETORNO REFEICAO') OR cod_ref_parada in (2,3,4,14)) AND fl_deletado IS NULL ORDER BY dt_posicao_parada, hr_posicao";
                                // string sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada between '" + txtDtInicial.Text + "' and '" + txtDtFinal.Text + "' order by dt_posicao_parada, hr_posicao";
                                SqlDataAdapter adtp4 = new SqlDataAdapter(sql4, con);
                                DataTable dt4 = new DataTable();
                                    ...
                                    if (dt4.Rows[w][2].ToString() == "PARADA REFEICAO")
                                    {
                                        ...
                                        if (a >= 0)
                                        {
                                            ...
                                            if (dt4.Rows[a][2].ToString() == "INICIO DE JORNADA" || dt4.Rows[a][2].ToString() == "INICIO JORNADA CAMINHAO" || dt4.Rows[a][2].ToString() == "INICIO JORNADA")
                                            {
                                                ...
                                                write.WriteLine(cracha + ";" + data + ";" + hora + ";2;0193");
                                    ...
                                    if (dt4.Rows[w][2].ToString() == "PARADA CLIENTE / FORNECEDOR")
                                    {
                                        ...
                                        else if (dt4.Rows[w][5].ToString() == "14")
                                        {
                                            ...
                                            if (a >= 0)
                                            {
                                                ...
                                                {
                                                    if (dt4.Rows[a][5].ToString() == "3" || dt4.Rows[a][5].ToString() == "2" || dt4.Rows[w][5].ToString() == "4")
                                                    {
                                                        write.WriteLine(cracha + ";" + data + ";" + hora + ";1;0202");
                                                        write.WriteLine(cracha + ";" + data + ";" + hora + ";2;0193");
                                                    }
                                        ...
                                        if (a >= 0)
                                        {
                                            if (dt4.Rows[a][2].ToString() == "PARADA CLIENTE / FORNECEDOR")
                                            {
                                                ...
                                                if (dt4.Rows[a][5].ToString() == "14")
                                                {
                                                    ...
                                                    write.WriteLine(cracha + ";" + data + ";" + hora + ";1;0293");
                                                    write.WriteLine(cracha + ";" + data + ";" + hora + ";1;0102");
                                                    write.WriteLine(cracha + ";" + data + ";" + DateTime.Parse(hora).AddMinutes(1).ToString("HH:mm") + ";1;0202");
                    ...
                    if (dt3.Rows.Count > 0)
                    {
                        if (dt3.Rows[0][6].ToString() == "INICIO DE JORNADA" || dt3.Rows[0][6].ToString() == "REINICIO DE VIAGEM" || dt3.Rows[0][6].ToString() == "PARADA PERNOITE")
                        {
                            ...
                            if (dtv.Rows[0][0].ToString() == "FIM DE JORNADA")
                            {
                                ...
                                sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada='" + DateTime.Parse(dte.Rows[f][0].ToString()).ToString("yyyy-MM-dd") + "' AND (ds_macro IN ('INICIO DE JORNADA', 'INICIO JORNADA CAMINHAO', 'PARADA REFEICAO', 'FIM DE JORNADA','REINICIO DE VIAGEM','FIM DE VIAGEM', 'PARADA','PARADA INTERNA','INICIO DE VIAGEM','RETORNO REFEICAO') OR cod_ref_parada in (2,3,4,14,22)) AND fl_deletado IS NULL ORDER BY dt_posicao_parada, hr_posicao";
                                // string sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada between '" + txtDtInicial.Text + "' and '" + txtDtFinal.Text + "' order by dt_posicao_parada, hr_posicao";
                                SqlDataAdapter adtp4 = new SqlDataAdapter(sql4, con);
                                DataTable dt4 = new DataTable();
                                ...
                                for (int w = 0; w < dt4.Rows.Count; w++)
                                {
                                    ...
                                    else if ((codigo.Length > 3 && codigo.Length <= 4) || codigosEspeciais.Contains(codigo))
                                    {
                                        cracha = "30" + codigo;
                                    }
                                    else
                            ...
                            else
                            {
                                ...
                                if (dti.Rows.Count > 0 && dtf.Rows.Count > 0)
                                {
                                    ...
                                    //sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada='" + txtDtInicial.Text + "' order by dt_posicao_parada, hr_posicao";
                                    sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada='" + DateTime.Parse(dte.Rows[f][0].ToString()).ToString("yyyy-MM-dd") + "' and hr_posicao >='" + dti.Rows[0][0].ToString() + "' or cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada='" + DateTime.Parse(dte.Rows[f][0].ToString()).AddDays(1).ToString("yyyy-MM-dd") + "' and hr_posicao <= '" + dtf.Rows[0][0].ToString() + "' AND (ds_macro IN ('INICIO DE JORNADA', 'INICIO JORNADA CAMINHAO', 'PARADA REFEICAO', 'FIM DE JORNADA','REINICIO DE VIAGEM','FIM DE VIAGEM', 'PARADA','PARADA INTERNA','INICIO DE VIAGEM','PARADA INTERNA','RETORNO REFEICAO') OR cod_ref_parada in (2,3,4,14,22)) AND fl_deletado IS NULL ORDER BY dt_posicao_parada, hr_posicao";
                                    // string sql4 = "select dt_posicao_parada, hr_posicao, ds_macro,cod_transmissao, cod_cracha, isnull(cod_ref_parada,0) as cod_ref_parada, cod_idveiculo from tb_parada where fl_deletado is null and cod_cracha=" + dt1.Rows[x][0].ToString() + " and dt_posicao_parada between '" + txtDtInicial.Text + "' and '" + txtDtFinal.Text + "' order by dt_posicao_parada, hr_posicao";
                                    SqlDataAdapter adtp4 = new SqlDataAdapter(sql4, con);
                                    DataTable dt4 = new DataTable();
        ...
        protected void btnGeraArquivo_Click(object sender, EventArgs e)
        {
        ...
        public void CarregaLista()
        {
            ...
            DropDownList1.Items.Add("(Selecione um Arquivo)");
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                System.IO.FileInfo arquivo = new System.IO.FileInfo(Request.ServerVariables["APPL_PHYSICAL_PATH"] + @"\TXT\" + DropDownList1.SelectedValue);
                Response.Clear();
