...
{
    public partial class GestaoDeCargasIpiranga : PaginaBase
    {
        ...
        {
            Response.Redirect("/dist/pages/Frm_CadPedidosIpiranga.aspx");
        }
