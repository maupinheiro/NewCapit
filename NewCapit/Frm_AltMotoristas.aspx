<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Frm_AltMotoristas.aspx.cs" Inherits="NewCapit.Frm_AltMotoristas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <span class="details">TIPO VEÍCULO:</span>
                    <asp:TextBox ID="txtTipoVeiculo" runat="server" ForeColor="Blue" Style="text-align: center" CssClass="form-control" placeholder="" AutoPostBack="true"></asp:TextBox>
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                    <span class="details">PLACA:</span>
                    <asp:TextBox ID="txtPlaca" runat="server" ForeColor="Blue" Style="text-align: center" CssClass="form-control" placeholder="" AutoPostBack="true"></asp:TextBox>
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                    <span class="details">REBOQUE 1:</span>
                    <asp:TextBox ID="txtReboque1" runat="server" ForeColor="Blue" Style="text-align: center" CssClass="form-control" placeholder="" AutoPostBack="true"></asp:TextBox>
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                    <span class="details">REBOQUE 2:</span>
                    <asp:TextBox ID="txtReboque2" runat="server" ForeColor="Blue" Style="text-align: center" CssClass="form-control" placeholder="" AutoPostBack="true"></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <asp:Label ID="lbUltimaAtualizacao" runat="server" ForeColor="Blue" CssClass="form-control" placeholder=""></asp:Label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <span class="details">ATUALIZADO POR:</span>
                    <asp:TextBox ID="txtAtualizadoPor" runat="server" ForeColor="Blue" CssClass="form-control" placeholder="" MaxLength="60"></asp:TextBox>
                </div>
            </div>
        </div>

        <!-- Linha 10 do formulário -->
        <div class="row g-3">
            <div class="col-md-1">
                <br />
