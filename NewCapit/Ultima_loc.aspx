<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Ultima_loc.aspx.cs" Inherits="NewCapit.Ultima_loc" EnableEventValidation="true"%>
        ...
        $j(document).ready(function () {
            ...
            $j.ajax({
                ...
                success: function (result) {
                    ...
                    // add data
                    $a("#FlexTable").flexAddData(formatEmployeeResults(obj));
                }
            });
