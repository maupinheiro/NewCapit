...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-5">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h3 class="h3 mb-2 text-gray-800">..: <i class="fas fa-user-friends"></i>NOVO CADASTRO :..
            </h3>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-1">
                <br />
                <asp:Button ID="btnAgregado" runat="server" Text="Pesquisar" CssClass="btn btn-outline-warning" />
            </div>
            <div class="col-md-7">
                <div class="form_group">
                    <span class="details">PESSOA:</span>
                    <asp:DropDownList ID="cboPessoa" runat="server" ForeColor="Blue" CssClass="form-control" Width="250px">
        ...
        <div class="row g-3">
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtCpf_Cnpj" runat="server" ForeColor="Blue" CssClass="form-control" placeholder="" data-mask="000.000.000-00"></asp:TextBox>
                </div>
            </div>
            <div class="col-md-1">
                <br />
                <asp:Button ID="btnPesqCnpj" runat="server" Text="Pesquisar" CssClass="btn btn-outline-warning" />
            </div>
            <div class="col-md-5">
                <div class="form-group">
